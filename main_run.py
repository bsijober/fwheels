...
class MainRun:
    ...
    def reset(self):
        self.rec = True
        self.offset_time = self.time_clock_imu1
...
#                        print('bank '+str(self.bank)+'attitude '+str(self.attitude) +'heading '+str(self.heading))
    ...
    def plot(self):
        ...
        text = font.render('%.1f deg  %.1f rpm %.1f km/h  %.1f m %.1f s' %(self.pedal_angle, ((self.gyr_z*60)/(2*np.pi)), self.bike_speed, self.distance, self.time_clock_imu1 - self.offset_time), 1, (255, 255, 255))
